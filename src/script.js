...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (window.innerWidth > 900) {
        ...
        glow.style.cssText = `
            ...
            height: 200px;
            border-radius: 50%;
            background: radial-gradient(circle, rgba(226, 165, 56, 0.03) 0%, transparent 70%);
            pointer-events: none;
            z-index: 9999;
            transform: translate(-50%, -50%);
            transition: left 0.1s ease, top 0.1s ease, opacity 0.25s ease;
        `;
        ...
        document.addEventListener('mousemove', (e) => {
            ...
            glow.style.opacity = (e.target.closest && e.target.closest('.btn')) ? '0' : '1';
        });
    }
    ...
    /* ========================================
       ...
       ======================================== */
    const email = 'timmor002' + '@' + 'gmail.com';
    ...
    if (copyBtn) {
        ...
        copyBtn.addEventListener('click', async () => {
            ...
            copyBtn._t = setTimeout(() => {
                label.textContent = 'Kopieer e-mail';
